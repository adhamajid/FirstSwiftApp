    ...
    @Binding var animateBG: Bool
        ...
        ZStack{
            ...
            VStack(alignment: .leading, spacing: 25){
                ...
                MenuButton(title: "Premium Accesss", image: "square.grid.2x2", offset: 0)
                    .padding(.top,40)
                
                MenuButton(title: "Upload Content", image: "square.and.arrow.up", offset: 10)
                ...
                MenuButton(title: "Logout", image: "arrow.left.to.line.alt", offset: 0)
